  ...
  describe('basic test suite', function () {
    ...
    it('does a basic database operation', function () {
      ...
      return new Promise(function (resolve, reject) {
        ...
        expect(res.rows.item(0)['1 + 1']).toBe(2);
      });
    });
    ...
    it('does multiple queries', function () {
      ...
      return new Promise(function (resolve, reject) {
        ...
        expect(res.rowsAffected).toBe(0);
        expect(res.rows.length).toBe(1);
        expect(res.rows.item(0)['2 + 1']).toBe(3);
      });
    });
    ...
    it('does multiple queries, same event loop', function () {
      ...
      return new Promise(function (resolve, reject) {
        ...
        expect(results[0].rows.item(0)['1 + 1']).toBe(2);

        expect(results[1].rowsAffected).toBe(0);
        expect(results[1].rows.length).toBe(1);
        expect(results[1].rows.item(0)['2 + 1']).toBe(3);
      });
    });
    ...
    it('queries executed in right order', function () {
      ...
      return new Promise(function (resolve, reject) {
        ...
        expect(called).toEqual(["a","k","b","l","c","j","m","n","e","i","f","h","o","g"]);
      });
    });
  ...
  describe('dedicated db test suite - in-memory', function () {
    ...
    it('returns correct rowsAffected/insertId 1', function () {
      ...
      return transactionPromise(db, sql).then(function (res) {
        expect(getInsertId(res)).toBe(void 0);
        expect(res.rowsAffected).toBe(0);
        expect(res.rows.length).toBe(1);
      }).then(function () {
        var sql = 'SELECT 1 + 2';
    ...
    it('returns correct rowsAffected/insertId 2', function () {
      ...
      return transactionPromise(db, sql).then(function (res) {
        ...
        expect(res.rowsAffected).toBe(0);
        expect(res.rows.length).toBe(1);
        expect(res.rows.item(0)).toEqual({
          text1: 'foo',
          text2: 'bar'
        });
      });
    ...
    it('returns correct rowsAffected/insertId 4', function () {
      ...
      return transactionPromise(db, sql).then(function (res) {
        ...
        expect(res.rows.item(1)).toEqual({
          text1: 'bongo',
          text2: 'haha'
        });
      });
    ...
    it('issue #33 - mixed string/null', function () {
      ...
      return transactionPromise(db, sql).then(function () {
        ...
        expect(res.rows.item(2)).toEqual({
          text1: "toto",
          text2: null
        });
        expect(res.rows.item(3)).toEqual({
          text1: "buzz",
          text2: "bozz"
        });
        expect(res.rows.item(4)).toEqual({
          text1: null,
          text2: null
        });
      });
  ...
  describe('advanced test suite - actual DB', function () {
    ...
    it('handles errors and callback correctly 4', function () {
      ...
      return new Promise(function (resolve, reject) {
        ...
        expect(called).toEqual(["a", "b", "c", "d", "e", {"1": []}, {"2": []}, {"3": []}, {"4": []}]
        );
      });
    });
    ...
    it('rolls back after an error 1', function () {
      ...
      return new Promise(function (resolve, reject) {
        ...
        expect(called).toEqual(["a", "b", "c", [{"foo": "a"}]]);
      });
    });
    ...
    it('rolls back after an error 3', function () {
      ...
      return new Promise(function (resolve, reject) {
        ...
        expect(called).toEqual(["a", "b", "d", "c", "e", "f", [{"foo": "a"}]]);
      });
    });
    ...
    it('rolls back after an error 4', function () {
      ...
      return new Promise(function (resolve, reject) {
        ...
        expect(called).toEqual(["a", "b", "d", [{"foo": "a"}]]);
      });
    });
    ...
    it('rolls back after an error 5', function () {
      ...
      return new Promise(function (resolve, reject) {
        ...
        expect(called).toEqual(["a", "b", "d", "e", "f", [{"foo": "a"}]]);
      });
    });
    ...
    it('does not roll back if caught 1', function () {
      ...
      return new Promise(function (resolve, reject) {
        ...
        expect(called).toEqual(["a", "b", "d", "g", "e", [{"foo": "a"}]]);
      });
    });
    ...
    it('query order matters 1', function () {
      ...
      return new Promise(function (resolve, reject) {
        ...
        expect(called).toEqual(["y", "a", "z", [{"foo": "y"}]]);
      });
    });
    ...
    it('query order matters 5', function () {
      ...
      return new Promise(function (resolve, reject) {
        ...
        expect(called).toEqual(["a", "c", "b", [{"foo": "y"}]]);
      });
    });
    ...
    it('query order matters 6', function () {
      ...
      return new Promise(function (resolve, reject) {
        ...
        expect(called).toEqual(["a", "e", "b", "c", "d", [{"foo": "x"}]]);
      });
    });
